...
Figure 4 depicts historical trends and projections for GDP and population in the BAU scenario as well as two alternative SSP scenarios to assess uncertainties in future trends (see below). The scenarios describe the period from present to 2050, which is the time horizon agreed upon with the stakeholders at the inception workshop. [^1]. @Assumptions on GDP growth and population growth for the rest of the world are presented in @Figure A1 in the Annex. 
...
Finally, to model the BAU scenario, we also make assumptions on area of protected land, change in diets, food loss and waste, and trade at the global level. @Table A2 in the Annex, presents details on these global scenario assumptions and how they are modeled in GLOBIOM. 
...
_Table 2: Assumptions diversification scenario_
...
Mitigation policies aimed reduce carbon emissions by taxing the carbon emissions released from deforestation and conversion of other natural land will have impacts on the development of agriculture in Zambia, food security, trade and land use change (LUC). We explored the transmission of land from forest and other natural land to grassland and cropland under mitigation policies targeting emissions from land use change and a range of carbon prices that begin to take effect in 2020 (Table 4 and Figure 21). The design of these policies will impact their effectiveness to reduce emissions while limiting the other trade-offs for the development of the agriculture sector. Policies that target only emission from LUC for cropland area, such as the Brazilian soy moratorium or the Indonesian ban on oil palm plantations, may temporarily stave land use change but are often either too lenient to be effective in limiting land use change. While rapid growth in biofuel demand or expansion of a single crop production impacts potential land use change these developments are often tied to other crops and agriculture sectors, such as livestock grazing, as is the case in Brazil. We examined two policies to look at the trade-offs between policies that would tax emission from land use change for deforestation or expansion of cropland area (LUC_Crp) and emissions from deforestation and expansion of all agricultural area, which includes cropland and grassland area (LUC_AG). 


_Table 4: Mitigation scenarios_ 

```{r table_mitt}
tab_mitt <- read_excel(file.path(root, "Fig_tab_map/external/tables.xlsx"), sheet = "table_mitt")
...
_Fig 22: Cropland area in 2050 under BAU and mitigation scenarios_.  
...
_Figure 23 Difference in crop production in 2050 under mitigation scenarios and carbon prices (% difference)_ 
...
_Figure 24: Temperature and precipitation change for 5 GCMs and RCP 8.5 (1980/2000-2040/2060)_
...
_Figure 26: Crop yield change due to climate change by 2050 (%): Selected crops_
...
SSP1 and SSP3 can be regarded as the scenarios that represent the bandwidth of the socio-economic spectrum, including uncertainties related to both external (global markets and the political situation) and internal conditions. This is illustrated by Figure 4 and 5, which shows that GDP, Population and yield projections of both scenarios on comparison to SSP1, the business as usual scenario. Projections for the rest of the world are provided in the Annex.
...
Under the BAU, the number of ruminant cattle increased with 90% from 2,6 million to 5 million heads for the period 2000-2050, which is still well below the vision of 6 million heads in 2050 (Figure 29). Measuring the development of the livestock sector in heads, however, presents only a partial picture. In reality, the increase in feed conversion efficiency over time will result in livestock units that produce more output over time (e.g. milk, eggs and meat). @Herrero2014 estimated that the feed conversion efficiencies in Sub-Saharan Africa would increase by 50% over the next 40 years under the middle of the road SSP2. The results in presented in Figure 29, which shows an increase in ruminant meat production of around 300% from 2000-2050. This comes from an increase in the feeding efficiencies of ruminant livestock.  

_Figure 29: BAU Ruminant Meat Production_
...
In 2000, agricultural land (crop and grassland) accounts for around 23% of the total land cover and cropland only 1.4%. 65% of the total land cover of Zambia in 2000 was forest area. Under the BAU, cropland area expands by 1.4 Mha between 2000 and 2050, with total agricultural land (cropland and grassland) expanding by almost 2.4 Mha (Figure 30). Most of the new agricultural land comes from forest, reducing the total forest area by 6%. 

Figure 31a-d presents a spatial representation of the land use change for the period 2010-2050 by land use types. The maps show the land distribution in 2010 and 2050 as well as their difference. The annual maps are produced at a resolution of 5 arcmin (~10 x 10 km) and depict for each class, the share of a land class (e.g. cropland) in the grid cell. The land use change map depicts the percentage point change over time. All maps also show the four AEZs in Zambia. Most of the land use change is projected to take place in the Southern and Western provinces located in AEZ I and AEZ IIa.  These are the areas where most maize is produced because of the suitable soil and climate conditions. For the same reason, these are also the regions where the model projects the expansion of cropland that is required to increase maize production in the future. Grassland expansion is projected to take place in the same regions. The increase in cropland and grassland will be at the expense of forest and other natural land. 

Figure 31b zooms in on the historical trend and BAU projection for cropland, showing area by crop as well as the vision target. According to vision, cropland should expand no more than 0.9 Mha thousand ha. FAOSTAT data indicates that the cropland area strongly increased from around 1.1 Mha in 2008 to almost 2 Mha in 2013, predominantly due to the expansion of maize area (and to a lesser extent cotton area). This pattern is a clear divergence from the BAU trend of the previous two decades. To account for this we use the average cropland for the period 2000-2013 (1.14 Mha) as a baseline to calculate the vision target in 2050. Figure 32 shows that under the BAU the total cropland will nearly identical to the maximum expansion as stated in the vision. Climate change impact on land use change is relatively small.
...
_Figure 31: Land use change maps by class_
...
_Figure 35: BAU agricultural GHG Emissions_
...
_Figure 36: BAU LULUCF GHG Emissions_
...
_Figure 37: Yield change in comparison to the BAU_
...
_Figure 38: Crop production change in comparison to the BAU_
...
_Figure 40: Food availability change in comparison to the BAU_
...
Figure 41 compares nett trade between the BAU (none) and the CSA options in 2050. The increase in crop yield caused by the adoption of CSA strategies result in higher exports because of an increase in international competitiveness. Comparing Figure 37 that shows the yield impact and the figure for exports shows a similar pattern. For example, ca and msd have the highest impact on yield and trade for maize and cotton, respectively. An interesting result is that Zambia becomes turns into a nett exporter of groundnuts in the div scenario as a consequence of lower relative price triggered by lower input costs. 
...
_Figure 42: Emissions from synthetic fertilizers change in comparison to the BAU_
...
_Figure 44: Crop yield under different socio-economic scenarios_
...
_Figure 45: Crop production under different socio-economic scenarios_
...
_Figure 46: Land use change under different socio-economic scenarios_
...
_Figure 47: Emissions from synthetic fertilizers under socio-economic scenarios_
...
_Figure 48: Yield in under different socio-economic scenarios and CSA practices_
...
_Figure 49: production under different socio-economic scenarios and CSA practices_
...
_Figure 50: Cropland change under different socio-economic scenarios and CSA practices_
...
_Figure 51: Emissions from synthetic fertilizers under different socio-economic scenarios and CSA practices_
