...
Under the BAU, the number of ruminant cattle increased with 27% from 2,9 million to 3.7 million heads for the period 2010-2050, which is still well below the vision of 6 million heads in 2050 (Figure X). Measuring the development of the livestock sector in heads, however, presents only a partial picture. In reality, the increase in feed conversion efficiency over time will result in livestock units that produce more output over time (e.g. milk, eggs and meat). @Herrero2014 estimated that the feed conversion efficiencies in Sub-Saharan Africa would increase by 50% over the next 40 years under the middle of the road SSP2. The results in presented in Figure X, which shows an increase in ruminant meat production by more than 1370% from 2010-2050. (Figure X). This comes from an increase in the feeding efficiencies of ruminant livestock.  
...
In 2010, agricultural land accounts for slightly over 30% of the total land cover and cropland only 2%. 65% of the total land cover of Zambia in 2010 was forest area. Under the BAU, cropland area expands by almost 1.5 Mha between 2010 and 2050, with total agricultural land (cropland and grassland) expanding by almost 4 Mha (Figure Xa). Most of the new agricultural land comes from forest, reducing the total forest area by 5%. 
...
Figure X shows the nett agricultural trade (exports minus imports) for a number of key agricultural commodities for 2010 and 2050 as well as the vision target of doubling (nett) exports in 2050. The results are mixed. For cotton, millet and maize, nett trade is positive in 2010 and an increase is expected for 2050. Only in case of maize and millet, the target of doubling net trade will be achieved. For cassava and sugar cane, which also exhibit a positive nett trade in both 2010 and 2050, a decrease is projected. For bovine meat nett trade was negative in 2010 but becomes positive in 2050. Finall, for groundnut, pig meat, rice, soya, sweet potatoes and wheat, net imports (negative net trade) are expected to increase even further. The error bars indicate that climate change can have substantial impact on the trade balance of several crops, in particular cassava, maize, cotton, millet and sugar cane. In the latter case, in one extreme climate scenario nett trade is projected to be higher than the 2010 value, almost reaching the vision target, while in the other extreme scenario, net trade will become negative.  
...
# Additional scenario: Constraining arable land expansion

[Section with an additionals scenario to assess the impact of constraining the expansion of cropland and grassland on emissions, food availability etc]
