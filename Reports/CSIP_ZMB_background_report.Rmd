...
In GLOBIOM we model the impact of the adoption of different CSA practices/technologies on the productivity of the agriculture sector as well as the potential for CSA mitigation of GHG emissions. We have used the structural model developments from @Frank2018 to further develop the mitigation options for Zambia. We futher refined the assumptions of yield and mitigation potential of some of the mitigation technology options from @Beach2015 based on the stakeholder workshop held in April 2018. 

The emission savings for each technical mitigation option are multiplied by GLOBIOM production system specific (crop- or livestock sector) emission factors to calculate absolute emission savings. This modeling approach explores the impact of the adoption of the mitigaiton options and therefore does not consider the direct costs and labor costs, change in input costs of each mitigation technology.  


[add]
_Figure X: adoption curve_ 
...
Note: Average of 2 crop models and 5 GCMs, using area harvested in 2000 as weights. Crop area in 2000 is used to calculate the national average yield. Data are for subsistence farming systems.
...
# Results
Quantifying impacts of technologies with global models provides additional insights to the regional assumptions, as well as offer context for the impact of global developments on the region, giving policy makers more detailed information. Additionally, a model represent a structured set of assumptions that can be used to challenge the ideas proposed by the visions and to check the visions for internal consistentency. In an iterative process, the Zambian stakeholders challenged the modelling results if they thought these were not plausible from a regional perspective.


##Indicators of impacts 
We have compared the impacts of the Business as Usual future with the scenarios that include the CSA technolgoies and options under a range of indicators related to:

  --	economic development: crop production, livestock production and numbers, and net trade 

  --	food security: average daily per capita calorie availability

  --  climate change mitigation: AFOLU (Agriculture, Forestry, and Other Land Uses) greenhouse gas (GHG) emissions 

  --	terrestrial biodiversity: crop yields, cropland area, and area of forests and other natural vegetation

 

- Crop Production 

The supply of crop products, as an indicator does not enough provide context for achieving food security, as historically in many regions, increases in production have come from the expansion of cropland area rather than through intensification or yield improvements [@Alcott2005; @Byerlee2014; @Hertel2014]. 

- Crop Yields

Using an average yield crops, as an indicator, provides us with measure of the overall productivity of cropland and provide a context for examining the potential impacts of the CSA technologies.


- Livestock production and Livestock heads

Livestock is modeled using a detailed representation of the global livestock sector where distinctions are made among dairy and other bovines, dairy and other sheep and goats, laying hens and broilers, and pigs [@Havlik2014, @Herrero2014]. Livestock production activities are defined by production systems [@Herrero2013]: for ruminants, grass based (arid, humid, and temperate/highlands), mixed crop-livestock (arid, humid, and temperate/highlands), and other; for monogastrics, smallholders and industrial. For each species, production system, and region, a set of input-output parameters is calculated based on the approach in @Herrero2013.


- Cropland and Land use change

While productivity gains can increase profitability and may incentivize expanding cropland and grassland, in what is known as Jevon’s paradox [@Alcott2005; @Byerlee2014; @Hertel2014], we also examine the change in irrigated and rainfed cropland, grassland, forest, and other natural lands to determine to what extent productivity gains from irrigation is sparing land for protection of terrestrial ecosystems and climate stabilization. 

- Food Consumption

We use the demand for crop products for food, livestock feed, bioenergy and fiber as an indicator of the food security needs of a wealthier, growing population. Our analysis uses kilocalorie availability per capita per day as an additional indicator to measure food security, considers the total food products demanded by a region and translates the quantity of product to calories. 

- Trade

Examining a region's imports or exports as a share of the domestic consumption allows us to assess the agricultural self-sufficiency or dependence on the outside world. 

- Agriculture, Forestry, and Other Land Use (AFOLU) GHG emissions

Examining emissions from the AFOLU (Agriculture, Forestry, and Other Land Use) sector allows us to contextualize climate stabilization through the impacts of expanded afforestation and biomass production for energy use, land use change such as deforestation and conversion of natural land to grassland and cropland, and the impacts of production of crop and livestock product. 
...
In the following section we compare the BAU with several scenarios which asked the question: What would the impact be if a certain CSA strategy was adopted in Zambia? The underlying assumptions of the productivity impacts, GHG mitigation, and maximum adoption of the CSA strategies was based on available literature as well as in consultation with the CSIP workshop participants and the CSA technical team.
