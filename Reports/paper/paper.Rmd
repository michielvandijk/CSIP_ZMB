...
author: "Michiel van Dijk, Amanda Palazzo, Petr Havlik and Tamas Krisztin"
...
[Refer to ISLAM: Global FoodSecurity10(2016)63–70 and Rosegrant diffusion of technology report, who uses similar approach of diffusion curves]
...
## summary of csa practices in Zambia

- Potential climate change impact
- Adoption rates

## Impact of CSA on productivity
...
### RCP x GCM x crop model

## CSA practices
- table with definition, source, yield, GHG etc.
- Should we consider livestock CSA practices? => Stefan
...
- non-CO2/CO2 reduction of -2.2 % in comparison to conventional farming systems 
...
- Target crop: Maize
- Yield increase of doubling of maize yields in comparison with conventional farming systems
- GHG emission (N2O) reduction of 3 % in comparison to conventional farming systems
...
- Target crop: Maize
- Yields impacted by climate change are buffered by 50% in comparison with conventional (using non-improved traditional seeds) farming systems.
...
In 2010, agricultural land accounts for slightly over 30% of the total land cover and cropland only 2%. 65% of the total land cover of Zambia in 2010 was forest area. Under the BAU, cropland area expands by almost 1.5 Mha by 2050, with total agricultural land (cropland and grassland) expanding by almost 4 Mha (Figure Xa). Most of the new agricultural land comes from forest, reducing the total forest area by 5%. 
...
Approximately 2.3 million ha of forest area is converted to grassland and cropland in the BAU which represents about 5% of the total forested area. Although the productivity impacts from adopting the technology increase the yields and production levels in Zambia, there is no land sparing to forests. For natural land, there is slightly more conversion under phl (-1) and the other options (<1%) because the resulting increases in productivity increases the profitability of the adopting farmers. In the scenario set up, adopting farmers practising all types of management (subsistence and high input farmers) are able to realize the gains from adopting the CSA strategies. For these farmers it is still more profitable to expand into forested and other natural areas than to shift into more intensive management practices. It should also be noted that in some cases the practices are only adopted on a share of the cropland area and a subset of crops, however if the practices were adopted over the entire cultivated area and farmers may be more inclined to intensify.
