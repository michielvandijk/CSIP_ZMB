...
Figure X shows the GHG emissions from LULUCF and agriculture for the BAU scenario. GLOBIOM is only able to estimate the GHG emissions as a consequence of land use conversion and crop and livestock production. The burning of biomass and the burning of savanna, the largest contributors to GHG emissions, are not modelled. This implies that the figure only shows a very small share of total future GHG emissions in Zambia. Also due to differences in methodology it is not possible to directly compare the historical series (in particular GHG caused by land use change) with the GLOBIOM projections. For this reason only the model results are shown.  
...
[@ADD CC impact and link with vision]
