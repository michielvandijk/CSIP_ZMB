...
The increase in corn production from the adoption of the residue rentention reduces the imports of maize dropping to only 5% of the domestic market share by 2050. The impacts on imports in the other CSA scenarios are limited since the relative increase in production compared to BAU is also about 1%. 
...
The biophysical impacts of climate change modeled by EPIC and LPJmL move in opposite directions. Maize yields from LPJmL are on average 21% lower than with no climate change assumptions. Maize yields from EPIC are on average about 1 percent higher than yields with no climate change assumptions. Drought tolerant maize performs better under climate change than the other CSA technolgoies, in part because of the design of the strategy where impacts from climate are dampened. Residue retention has slightly more negative impacts on maize yields, however, this could be due to the spillover productivity impacts from other crops which see less maize cultivated (which could lower the overall yield).  
