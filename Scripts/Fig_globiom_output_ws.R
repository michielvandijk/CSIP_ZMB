...
# File
globiom_file <- "/GLOBIOM/results/20180417 2nd workshop/output_CSIP_ZMB_all_15apr18_new2"
...
globiom_raw <- readRDS(file.path(root, paste0("Cache/globiom_raw_2018-04-16.rds"))) 
